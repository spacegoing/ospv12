...
if __name__ == "__main__":
  ...
  parser.add_argument(
    "--drop_short_ratio", type=float, default=1.0
  )
  ...
  parser.add_argument(
    "--model_max_length", type=int, default=512
  )
  ...
  parser.add_argument(
    "--tile_overlap_factor", type=float, default=0.125
  )
  ...
  parser.add_argument(
    "--compress_kv_factor", type=int, default=1
  )
  parser.add_argument(
    "--interpolation_scale_h", type=float, default=1.0
  )
  parser.add_argument(
    "--interpolation_scale_w", type=float, default=1.0
  )
  parser.add_argument(
    "--interpolation_scale_t", type=float, default=1.0
  )
  parser.add_argument("--downsampler", type=str, default=None)
  parser.add_argument(
    "--ae", type=str, default="stabilityai/sd-vae-ft-mse"
  )
  parser.add_argument(
    "--ae_path", type=str, default="stabilityai/sd-vae-ft-mse"
  )
  parser.add_argument(
    "--text_encoder_name",
    type=str,
  ...
  parser.add_argument(
    "--enable_stable_fp32", action="store_true"
  )
  parser.add_argument(
  ...
  # validation & logs
  parser.add_argument(
    "--num_sampling_steps", type=int, default=20
  )
  parser.add_argument(
